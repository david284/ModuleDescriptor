...
data = {
    ...
    "nodeVariables": [
        {
            "displayTitle": f"Palette entry ${{channel {e+1}}}",
    ...
    "eventVariables": [
        {
            ...
            "groupItems": [
                ...
                },
                {
                    ...
                    "bitMask": 0xF,
                    "options": [
                        {"value": p, "label": f"${{channel{p+1}}}"} for p in range(0, paletteSize)
                    ]
                },
                {
                    "type": "EventVariableSelect",
                    ...
                    "bitMask": 0xF0,
                    "options": [
                        {"value": p << 4, "label": f"${{channel{p+1}}}"} for p in range(0, paletteSize)
                    ]
                }
            ]
