...
data = {
    ...
    "numberOfChannels": output_channels + input_channels,
    "channelNames": {str(ch): f"Output {ch}" for ch in range(1, output_channels + 1)} |
                    {str(ch + output_channels): f"Input {ch}" for ch in range(1, input_channels + 1)},
    "nodeVariables": [
        {
